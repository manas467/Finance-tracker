        ...
        messages: [
          {
            role: "system",
            content:
              "You are a smart finance assistant. Analyze the following financial transactions in Indian Rupees (₹) and provide smart spending insights. Always show currency in ₹."
          },
          {
            role: "user",
